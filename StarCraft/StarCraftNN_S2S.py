        ...
        for embed in EMBEDDINGS:
            ...
            for epoch in Epochs:
                ...
                for batch in BATCHS:         
                    ...
                    name="StarCraftNN-S2S_CONTEXT="+str(CONTEXT_SIZE)+"_LENGTH="+str(length)+"_EMBEDINNGS="+str(embed)+"_EPOCHS="+str(epoch)+"_BATCH="+str(batch) 
                    print("\n-I- Running name:  \n\t" + name)
                    ...
                    try:
                        for ep in range(EPOCHS):
                            ...
                            for dir_idx in range(data_len):                                             
                                ...
                                state_length, data_states = GetData(dir_list[dir_idx])
                                print("-I- Dir name: "+str(dir_list[dir_idx])+", #states = "+str(state_length))
                                if state_length == 0:
                                    continue
                                model.zero_grad()
